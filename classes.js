...
class Machine {
  constructor(widgets_made_count, weat_and_tear_count, needs_reboot){
  ...
  makeWidgets(num) {
    this.widgets_made_count = this.widgets_made_count + num
      this.wear_and_tear_count = Math.floor((num/50)) + this.wear_and_tear_count
    
  }

  fixMachine() {
    this.needs_reboot = !this.needs_reboot
  }
